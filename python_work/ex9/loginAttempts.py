...
nine = User('norawee', 'laohateerapong', 17, 'male')

print('Making 5 login attempts...')
nine.increment_login_attempts()
nine.increment_login_attempts()
nine.increment_login_attempts()
nine.increment_login_attempts()
nine.increment_login_attempts()
print(f'Login attempts: {nine.login_attempts}')

print('Resetting loggin attempts...')
nine.reset_login_attempts()
print(f'Login attempts: {nine.login_attempts}')